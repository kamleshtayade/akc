...
class EventGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Event entity")
        ...
        .repeat(2) {
            ...
            .post("/api/events")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "number":"0", "eventStatus":null, "judgepanelStatus":null, "changed":"2020-01-01T00:00:00.000Z", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "entryCount":"0", "entryLimit":"0", "entryLimitType":null}""")).asJSON
            .check(status.is(201))
